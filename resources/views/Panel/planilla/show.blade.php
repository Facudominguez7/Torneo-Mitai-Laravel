    ...
    <div class="w-full max-w-4xl p-6 bg-white rounded-lg shadow-md">
        ...
        <form action="{{ route('planilla.agregarJugador') }}" method="POST" class="mb-4">
            ...
            <div class="mb-2">
                ...
                <input type="text" name="nombre_jugador" required class="mt-1 block w-full border-gray-300 rounded-md shadow-sm">
            </div>
            ...
            <div class="mb-2">
                ...
                <input type="text" name="apellido_jugador" required class="mt-1 block w-full border-gray-300 rounded-md shadow-sm">
            </div>
        
            <!-- Campo para el DNI del jugador -->
            <div class="mb-2">
                <label for="dni_jugador" class="block text-sm font-medium text-gray-700">DNI Jugador:</label>
                <input type="number" name="dni_jugador" required class="mt-1 block w-full border-gray-300 rounded-md shadow-sm">
            </div>
            ...
            <div class="mb-2">
                ...
                <input type="number" name="numero_camiseta" required class="mt-1 block w-full border-gray-300 rounded-md shadow-sm">
            </div>
                            ...
                            <td class="px-4 py-2 border-b">
                                <form action="{{ route('planilla.actualizarJugador') }}" method="POST" class="inline">
                                    ...
                                    <div class="flex items-center space-x-2">
                                        ...
                                        <input type="checkbox" name="asistencia" {{ $jugador->asistio ? 'checked' : '' }} class="h-4 w-4 text-blue-600 border-gray-300 rounded">
                                        <button type="submit" class="px-2 py-1 bg-green-500 text-white rounded-md">Actualizar</button>
                                    </div>
                                </form>
                            </td>
                        </tr>
