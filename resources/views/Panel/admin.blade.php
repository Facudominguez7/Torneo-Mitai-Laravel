    ...
    <aside id="sidebar-multi-level-sidebar"
        ...
        <div class="h-full px-3 py-4 overflow-y-auto bg-gray-50 dark:bg-gray-800">
            <ul class="space-y-2 font-medium">
                ...
                <li>
                    <a href="{{ route('equipo.index', ['idEdicion' => $idEdicion]) }}"
                        class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                    ...
                    <div
                        ...
                        <div class="min-w-0">
                            <h2 class="overflow-hidden text-ellipsis whitespace-nowrap">
                                {{ $EdicionSeleccionada->nombre }}</h2>
                        </div>
                    </div>
                </section>
            @endif
        </div>
        @if (request()->routeIs('equipo.show'))
            <section>
                @yield('detalle')
            </section>
        @endif
        <div class="flex-grow flex items-center justify-center mt-0">
            <section>
                @yield('contenido')
            </section>
        </div>
