    ...
    <div class="grid gap-6 p-1 md:p-6 md:bg-[--color-secondary] w-full md:w-auto">
        <div class="bg-white md:p-6">
            ...
            <form method="GET" action="{{ route('instancias-finales') }}"
                ...
                <label for="categoria" class="font-medium text-2xl mt-3">Filtrar por categoría:</label>
                                    ...
                                    @foreach ($partidosPorFase as $p)
                                        <div class="grid gap-4 p-6">
                                            <div class="bg-card rounded-lg shadow-sm">
                                                <div
                                                    class="flex flex-col md:flex-row items-center justify-between px-6 py-4">
                                                    <div class="flex items-center gap-2">
                                                        ...
                                                        <img src="{{ asset('fotos/equipos/' . $p->equipoVisitante->foto) }}"
                                                            ...
                                                            class="rounded-full"
                                                            style="aspect-ratio: 40/40; object-fit: cover;" />
                                                        <div class="font-medium">{{ $p->equipoVisitante->nombre }}
                                                        </div>
                                                    </div>
                                                    <div
                                                        class="flex flex-col text-center text-2xl font-bold mt-4 md:mt-0">
